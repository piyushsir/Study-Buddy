...
const Gallery = () => {
  const items = [
    ...
    { src: "/assets/images/brain.png", alt: "Memory", title: "PsychoMetric" },
    { src: "/assets/images/stream.png", alt: "Stream", title: "Mock Interview" },
    { src: "/assets/images/youtube.png", alt: "YT Video", title: "YT Video" },
    {
      src: "/assets/images/galaxy.jpg",
      alt: "Content Wizard",
      title: "Future Learnings",
    },
    { src: "/assets/images/computer.jpg", alt: "RoboHR", title: "Easy and Efficient" },
    { src: "/assets/images/tools.png", alt: "Tools", title: "Into 3023" },
  ];
